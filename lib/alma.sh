...
alma8() {
	cd $pool
	sudo wget -O AlmaLinux-8.iso https://repo.almalinux.org/almalinux/8.10/isos/x86_64/AlmaLinux-8.10-x86_64-minimal.iso
...
alma9() {
	cd $pool
	sudo wget -O AlmaLinux-9.iso https://repo.almalinux.org/almalinux/9.4/isos/x86_64/AlmaLinux-9-latest-x86_64-minimal.iso
